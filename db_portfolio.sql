...
--
-- Host: localhost:3306
-- Generation Time: Dec 01, 2018 at 12:42 AM
...
INSERT INTO `tbl_portfolio` (`id`, `page_appeared`, `project_title`, `project_desc`, `project_image`, `design_desc`, `project_tagline`, `project_indexdesc`, `project_aspect_one`, `project_aspect_two`, `project_aspect_three`) VALUES
(1, 'index_work_fellowship', 'FELLOWSHIP OF THE RING', 'Created a fully responsive website for the 20th anniversary release of the first Lord of the Rings film. Focused on a minimal and modern flat design, highlighting the film\'s yellow colour tones. Created all new logos and branding, while still remaining true to the original film\'s branding and design.', 'browser_lotr.png', 'The design approach for this website was a new take on something classic. Taking colours, type, and inspiration from the original film and combining them together to create a sleek updated version was the ultimate goal.', 'EXTENDED EDITION MOVIE RERELEASE', 'Created responsive website and design for 20th anniversary rerelease of the first Lord of the Rings film.', 'BRANDING', 'UX/UI DESIGN', 'RESPONSIVE WEBSITE'),
